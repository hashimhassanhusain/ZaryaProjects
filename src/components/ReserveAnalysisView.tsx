    ...
    >
      <div className="space-y-8 pb-20">
        <header className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-2xl font-semibold text-slate-900 tracking-tight italic uppercase">Reserve Analysis</h2>
        ...
        <section className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-6">
            <div className="bg-white border border-slate-100 rounded-[2.5rem] p-8 shadow-sm space-y-8">
              <div className="flex items-center justify-between">
                <h3 className="text-lg font-semibold text-slate-900 tracking-tight italic">Budget Composition</h3>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between px-2">
                    <span className="text-[10px] font-semibold text-slate-400 uppercase tracking-widest">Base Estimate (Known-Knowns)</span>
                    <span className="text-sm font-semibold text-slate-900">{formatCurrency(estimatedBudget)}</span>
                  </div>
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between px-2">
                    <div className="flex items-center gap-2">
                      <span className="text-[10px] font-semibold text-slate-400 uppercase tracking-widest">Contingency Reserve (Known-Unknowns)</span>
                      <AlertTriangle className="w-3 h-3 text-amber-500" />
                    </div>
                    <span className="text-sm font-semibold text-amber-600">{formatCurrency(contingencyReserve)}</span>
                  </div>
                  <div className="w-full h-4 bg-slate-100 rounded-full overflow-hidden">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between px-2">
                    <span className="text-[10px] font-semibold text-slate-400 uppercase tracking-widest">Management Reserve (Unknown-Unknowns)</span>
                    <span className="text-sm font-semibold text-rose-600">{formatCurrency(managementReserve)}</span>
                  </div>
                  <div className="w-full h-4 bg-slate-100 rounded-full overflow-hidden">
              ...
              <div className="pt-8 border-t border-slate-50 flex items-center justify-between">
                <div>
                  <p className="text-[10px] font-semibold uppercase tracking-widest text-slate-400">Total Project Budget (BAC)</p>
                  <p className="text-3xl font-bold italic tracking-tighter text-slate-900">{formatCurrency(finalBudget)}</p>
                </div>
                <button className="px-8 py-3 bg-slate-900 text-white rounded-2xl text-[10px] font-semibold uppercase tracking-widest hover:bg-slate-800 transition-all shadow-xl shadow-slate-100">
                  Lock Cost Baseline
                </button>
              </div>
            </div>
          ...
          <div className="space-y-6">
            <div className="bg-blue-600 rounded-[2.5rem] p-8 text-white space-y-6 shadow-xl shadow-blue-100">
              ...
              <h4 className="text-xl font-semibold italic tracking-tight">Reserve Strategy</h4>
            ...
            <div className="bg-slate-50 border border-slate-100 rounded-[2.5rem] p-8 space-y-4">
              <h4 className="text-[10px] font-semibold uppercase tracking-widest text-slate-400 italic">Financial Guardrail</h4>
