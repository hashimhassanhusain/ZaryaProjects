                ...
                {activities.map(act => (
                  ...
                  >
                    <div className="flex items-center justify-between mb-2">
                       <span className={cn("text-[9px] font-semibold uppercase tracking-widest", selectedActivityId === act.id ? "text-blue-500" : "text-slate-400")}>{act.id}</span>
                    ...
                    <h4 className="text-sm font-semibold tracking-tight mb-3 line-clamp-1">{act.description}</h4>
              ...
              {!selectedActivity ? (
                 <div className="h-[500px] flex flex-col items-center justify-center text-center space-y-6 bg-slate-50/50 border-2 border-dashed border-slate-100 rounded-[3rem]">
                    ...
                    <div className="space-y-2">
                       <h3 className="text-xl font-semibold text-slate-900 tracking-tight">Select a Lead activity</h3>
                 ...
                 <div className="space-y-8">
                    ...
                    <div className="bg-slate-900 rounded-[2.5rem] p-8 text-white relative overflow-hidden">
                       ...
                       <div className="relative z-10 flex items-center justify-between">
                          <div className="space-y-4">
                             <div className="flex items-center gap-3">
                                <span className="text-[10px] font-semibold uppercase tracking-widest text-blue-400">ACTIVE TARGET</span>
                                <span className="text-[10px] font-semibold uppercase tracking-widest text-slate-500 px-3 py-1 bg-white/5 rounded-full border border-white/10">{selectedActivity.id}</span>
                             </div>
                             <h2 className="text-3xl font-semibold italic tracking-tighter leading-tight max-w-lg">
                                {selectedActivity.description}
                             </h2>
                          </div>
                          <div className="text-right space-y-2">
                             <p className="text-[10px] font-semibold uppercase tracking-widest text-slate-500">Current Phase</p>
                             <div className="px-4 py-2 bg-blue-600 rounded-2xl font-semibold text-xs uppercase tracking-widest italic group hover:scale-105 transition-transform cursor-default">
                    ...
                    <div className="grid grid-cols-2 gap-8">
                       ...
                       <div className="bg-white border border-slate-100 rounded-[2.5rem] p-8 shadow-sm space-y-6">
                          <div className="flex items-center gap-3 mb-2">
                             ...
                             <h3 className="text-[11px] font-semibold uppercase tracking-widest text-slate-900">Duration Estimation</h3>
                          </div>
                          
                          <div className="space-y-4">
                             <div className="p-6 bg-slate-50 rounded-3xl space-y-3">
                                <label className="text-[10px] font-semibold uppercase tracking-widest text-slate-400 block ml-1">Planned Days</label>
                                <div className="flex items-center gap-4">
                                   <input 
                                     type="number"
                                     ...
                                     className="w-full bg-white border border-slate-200 rounded-2xl px-6 py-4 text-2xl font-semibold italic focus:ring-4 focus:ring-blue-500/10 transition-all"
                                   />
                       ...
                       <div className="bg-white border border-slate-100 rounded-[2.5rem] p-8 shadow-sm space-y-6">
                          <div className="flex items-center justify-between mb-2">
                             <div className="flex items-center gap-3">
                                ...
                                <h3 className="text-[11px] font-semibold uppercase tracking-widest text-slate-900">Predecessor Logic</h3>
                             </div>
                          ...
                          <div className="space-y-4">
                             {(selectedActivity.predecessors || []).map((dep) => (
                                <div key={dep.id} className="flex items-center justify-between p-4 bg-emerald-50/50 border border-emerald-100 rounded-2xl">
                                   <div className="flex items-center gap-3">
                                      ...
                                      <div>
                                         <p className="text-[10px] font-semibold text-emerald-900 uppercase tracking-tighter">
                             ...
                             <button className="w-full py-4 border-2 border-dashed border-slate-100 rounded-2xl flex items-center justify-center gap-2 text-slate-400 hover:border-blue-200 hover:text-blue-500 transition-all group">
                                ...
                                <span className="text-[10px] font-semibold uppercase tracking-widest group-hover:tracking-[0.15em] transition-all">Add Logic Tie</span>
                             </button>
                          </div>
                       </div>
                    </div>
                    ...
                    <div className="bg-slate-50/50 border border-slate-100 rounded-[2.5rem] p-8 flex items-center justify-between">
                       <div className="flex items-center gap-5">
                          ...
                          <div>
                             <h4 className="text-sm font-semibold text-slate-900">Advanced Logic Settings</h4>
                             <p className="text-[10px] text-slate-500 font-bold uppercase tracking-widest">Leads, Lags, and Relationship Constraints</p>
                          </div>
                       </div>
                       <button className="px-5 py-2.5 bg-slate-900 text-white rounded-xl text-[10px] font-semibold uppercase tracking-widest shadow-lg shadow-slate-900/10">
                          Open Logic Matrix
                       </button>
                    </div>
                 </div>
