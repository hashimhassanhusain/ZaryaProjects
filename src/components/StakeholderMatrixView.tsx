    ...
    >
      <div className="space-y-8 pb-20">
        <header className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-2xl font-black text-slate-900 tracking-tight italic uppercase">Power / Interest Matrix</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3 space-y-6">
            <div className="aspect-square bg-white border border-slate-100 rounded-[2.5rem] shadow-sm relative p-8">
              {/* Axes Labels */}
              <div className="absolute -left-12 top-1/2 -translate-y-1/2 -rotate-90 text-[10px] font-black uppercase tracking-widest text-slate-400">
                Power (Influence)
              </div>
              <div className="absolute -bottom-8 left-1/2 -translate-x-1/2 text-[10px] font-black uppercase tracking-widest text-slate-400">
              ...
              <div className="grid grid-cols-2 grid-rows-2 h-full w-full border-2 border-slate-900/5 rounded-3xl overflow-hidden relative">
                ...
                <div className="p-4 flex flex-col items-center justify-center text-center bg-amber-50/30 border-r border-b border-slate-100">
                   <p className="text-[10px] font-black uppercase text-amber-600 mb-1 opacity-40">Manage Closely</p>
                ...
                <div className="p-4 flex flex-col items-center justify-center text-center bg-blue-50/30 border-b border-slate-100">
                   <p className="text-[10px] font-black uppercase text-blue-600 mb-1 opacity-40">Keep Informed</p>
                ...
                <div className="p-4 flex flex-col items-center justify-center text-center bg-emerald-50/30 border-r border-slate-100">
                   <p className="text-[10px] font-black uppercase text-emerald-600 mb-1 opacity-40">Keep Satisfied</p>
                ...
                <div className="p-4 flex flex-col items-center justify-center text-center bg-slate-50/20">
                   <p className="text-[10px] font-black uppercase text-slate-400 mb-1 opacity-40">Monitor</p>
                ...
                <div className="absolute inset-0">
                   {stakeholders.map((sh) => (
                     ...
                     >
                        ...
                        <div className="absolute top-full mt-2 left-1/2 -translate-x-1/2 bg-slate-900 text-white px-2 py-1 rounded text-[9px] font-black uppercase whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity">
                           {sh.name}
                        </div>
                     </motion.div>
                   ))}
          ...
          <div className="space-y-6">
            <div className="bg-white border border-slate-100 rounded-[2.5rem] p-8 shadow-sm">
               <h3 className="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-6 italic">Priority Stakeholders</h3>
               <div className="space-y-4">
                  {stakeholders.sort((a,b) => (b.power + b.interest) - (a.power + a.interest)).slice(0, 5).map((sh) => (
                    <div key={sh.id} className="flex items-center gap-3 p-3 bg-slate-50 rounded-2xl hover:bg-purple-50 transition-colors group cursor-pointer">
                       ...
                       <div>
                          <p className="text-xs font-black text-slate-900 line-clamp-1">{sh.name}</p>
            ...
            <div className="bg-slate-900 rounded-[2.5rem] p-8 text-white space-y-6 shadow-xl shadow-purple-900/10">
               ...
               <h4 className="text-xl font-black italic tracking-tight">Classification Logic</h4>
