...
export const FocusAreaBar: React.FC = () => {
  const { selectedFocusArea, setSelectedFocusArea } = useUI();
      ...
      {FOCUS_AREAS.map(({ id, title, icon: Icon }) => {
        ...
        return (
          <button
            ...
            className={cn(
              'flex items-center gap-2 px-5 py-2.5 rounded-full text-[11px] font-black uppercase tracking-widest transition-all shrink-0',
              active
