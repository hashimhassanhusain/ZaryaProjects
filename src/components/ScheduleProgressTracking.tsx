      ...
      <div className="space-y-8 pb-20">
        ...
        <header className="flex items-center justify-between">
           <div className="space-y-1">
              <div className="flex items-center gap-3">
                 ...
                 <h2 className="text-2xl font-black text-slate-900 tracking-tight leading-none italic">Progress Tracker</h2>
              </div>
           ...
           <div className="flex items-center gap-3">
              <div className="px-5 py-2.5 bg-white border border-slate-200 rounded-2xl shadow-sm space-y-0.5">
                 <p className="text-[9px] font-black uppercase tracking-widest text-slate-400">Project Health</p>
                 <div className="flex items-center gap-2">
                    <span className={cn("text-sm font-black", isSlipping ? "text-rose-600" : "text-emerald-600")}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
           <div className="bg-slate-900 rounded-[2.5rem] p-8 text-white relative overflow-hidden group">
              ...
              <div className="relative z-10 space-y-6">
                 ...
                 <div>
                    <p className="text-[10px] font-black uppercase tracking-widest text-slate-500 mb-1">Time Elapsed</p>
                    <div className="flex items-end gap-2">
                       <span className="text-4xl font-black italic tracking-tighter">{avgTimeProgress}%</span>
           ...
           <div className="bg-white border border-slate-100 rounded-[2.5rem] p-8 shadow-sm relative group overflow-hidden">
              <div className="relative z-10 space-y-6">
                 ...
                 <div>
                    <p className="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-1">Physical Work (% Cost)</p>
                    <div className="flex items-end gap-2">
                       <span className="text-4xl font-black italic tracking-tighter text-slate-900">{avgCostProgress}%</span>
           ...
           <div className={cn(
             ...
             isSlipping ? "bg-rose-50 border-rose-100" : "bg-slate-50 border-slate-100"
              ...
              <div className="relative z-10 space-y-6">
                 ...
                 <div>
                    <p className="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-1">Schedule Variance</p>
                    <div className="flex items-end gap-2">
                       <span className={cn("text-4xl font-black italic tracking-tighter", isSlipping ? "text-rose-600" : "text-slate-900")}>
                        {slippageValue}%
                       </span>
           ...
           <div className="bg-blue-600 rounded-[2.5rem] p-8 text-white relative overflow-hidden group">
              ...
              <div className="relative z-10 space-y-6">
                 ...
                 <div>
                    <p className="text-[10px] font-black uppercase tracking-widest text-blue-200 mb-1">Items at Risk</p>
                    <div className="flex items-end gap-2">
        ...
        <div className="bg-white border border-slate-100 rounded-[3rem] p-10 shadow-sm space-y-8">
           <div className="flex items-center justify-between">
              <div className="space-y-1">
                 <h3 className="text-xl font-black text-slate-900 tracking-tight leading-none italic">S-Curve Analysis</h3>
              ...
              <div className="flex items-center gap-6">
                 <div className="flex items-center gap-2">
                    ...
                    <span className="text-[9px] font-black uppercase tracking-widest text-slate-500">Planned (Time)</span>
                 </div>
                 <div className="flex items-center gap-2">
                    <div className="w-3 h-3 rounded-full bg-emerald-500" />
                    <span className="text-[9px] font-black uppercase tracking-widest text-slate-500">Actual (Cost)</span>
                 </div>
              </div>
           </div>
        ...
        <section className="bg-white border border-slate-100 rounded-[3rem] overflow-hidden shadow-sm">
           <div className="p-10 border-b border-slate-50 flex items-center justify-between">
              <div className="space-y-1">
                 <h3 className="text-xl font-black text-slate-900 tracking-tight leading-none italic">Activity Tracking Matrix</h3>
                 <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Detail view of all scheduled tasks</p>
              </div>
              {isSlipping && (
                <button className="flex items-center gap-2 bg-rose-600 text-white px-6 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-widest animate-pulse">
              ...
              <table className="w-full text-left">
                 <thead>
                    <tr className="bg-slate-50/50">
                       <th className="px-10 py-5 text-[10px] font-black uppercase tracking-widest text-slate-400">Activity</th>
                       <th className="px-10 py-5 text-[10px] font-black uppercase tracking-widest text-slate-400">Work Package</th>
                       <th className="px-10 py-5 text-[10px] font-black uppercase tracking-widest text-slate-400 text-center">Time Progress</th>
                       <th className="px-10 py-5 text-[10px] font-black uppercase tracking-widest text-slate-400 text-center">Physical (% Cost)</th>
                       <th className="px-10 py-5 text-[10px] font-black uppercase tracking-widest text-slate-400 text-right">Variance</th>
                    </tr>
                 </thead>
                       ...
                       return (
                          <tr key={act.id} className="group hover:bg-slate-50/50 transition-all">
                             <td className="px-10 py-6">
                                <div className="space-y-1">
                                   <p className="text-[10px] font-black text-slate-400 uppercase">{act.id}</p>
                                   <h4 className="text-sm font-black text-slate-900 line-clamp-1">{act.description}</h4>
                                </div>
                             </td>
                             <td className="px-10 py-6">
                                <div className="px-3 py-1 bg-slate-100 rounded-lg inline-block">
                                   <span className="text-[10px] font-black text-slate-600 uppercase tracking-tighter">{act.workPackage}</span>
                                </div>
                             </td>
                             <td className="px-10 py-6">
                                <div className="flex flex-col items-center gap-2">
                                   <span className="text-xs font-black text-slate-600">{timeProgress}%</span>
                             ...
                             <td className="px-10 py-6">
                                <div className="flex flex-col items-center gap-2">
                                   <span className="text-xs font-black text-emerald-600">{costProgress}%</span>
                             ...
                             <td className="px-10 py-6 text-right">
                                <div className={cn(
                                   "inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-[10px] font-black uppercase",
        ...
        <section className="bg-blue-600 rounded-[2.5rem] p-10 text-white relative overflow-hidden group">
           ...
           <div className="relative z-10 flex items-center justify-between">
              <div className="flex items-center gap-8">
                 ...
                 <div className="space-y-1">
                    <h3 className="text-2xl font-black italic tracking-tighter">Forecast Completion</h3>
                    <p className="text-sm text-blue-100 font-medium">Based on current performance, projected finish is <span className="text-white font-black underline decoration-white/30 underline-offset-4">Oct 12, 2026</span></p>
                 </div>
              </div>
              <button className="flex items-center gap-3 bg-slate-900 text-white px-8 py-4 rounded-2xl text-[11px] font-black uppercase tracking-widest hover:scale-105 transition-all shadow-2xl shadow-slate-900/40">
                 Run Forecasting
