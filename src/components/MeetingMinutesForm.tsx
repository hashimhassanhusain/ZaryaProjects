...
export const MeetingMinutesForm: React.FC<MeetingMinutesFormProps> = ({ project, meeting, onSave, onCancel }) => {
  ...
  const generatePDFBlob = () => {
    ...
    doc.text('Generated by PMIS Project Management System', pageWidth / 2, 285, { align: 'center' });

    const fileName = `${project.code}-PMIS-MEETING-${typeLabel.replace(/\s+/g, '_')}-${formData.date}.pdf`;
        ...
        <div className="lg:col-span-1 space-y-8">
          ...
          <section className="bg-white rounded-3xl border border-slate-100 p-8 shadow-sm space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {/* Internal / PMIS Employees */}
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <h3 className="text-xs font-semibold text-slate-500 uppercase tracking-widest">PMIS Employees / موظفي PMIS</h3>
                </div>
