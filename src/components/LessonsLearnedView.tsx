...
export const LessonsLearnedView: React.FC<LessonsLearnedViewProps> = ({ page }) => {
  ...
  return (
    <StandardProcessPage
      ...
      actions={
        <DriveUploadButton
          drivePath="7_Performance_Reports_Quality_and_Communications/7.6_Archive_Old_Reports_and_Minutes"
          label="Upload Entry"
        />
      }
          ...
          >
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 items-start">
              ...
              <div className="lg:col-span-2 space-y-10">
                <section className="bg-white rounded-[3rem] border border-neutral-200 shadow-sm overflow-hidden transition-all hover:shadow-xl hover:shadow-neutral-200/40">
                  <div className="p-8 border-b border-neutral-100 bg-neutral-50/50 flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-[10px] text-neutral-500 font-bold uppercase tracking-widest">{t('knowledge_capture')}</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-3">
                      <select 
                        ...
                        className={cn(
                          ...
                          formData.status === 'Archived' ? "bg-neutral-50 text-neutral-500 border-neutral-200" :
                  ...
                  <div className="p-10 space-y-12">
                    <section className="space-y-6">
                      <h3 className="text-[10px] font-bold text-neutral-900 uppercase tracking-[0.2em] flex items-center gap-2">
                        <div className="w-1.5 h-1.5 rounded-full bg-neutral-900" />
                        Contextual Identification
                      </h3>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="space-y-2">
                          <label className="block text-xs font-bold text-neutral-500 uppercase tracking-widest ml-1">Lesson ID</label>
                          <input 
                            type="text"
                            value={formData.lessonId}
                            onChange={(e) => setFormData({ ...formData, lessonId: e.target.value })}
                            className="w-full px-5 py-4 bg-neutral-50 border border-neutral-200 rounded-2xl text-sm font-bold text-neutral-900 focus:ring-4 focus:ring-emerald-500/10 focus:border-emerald-500 transition-all outline-none"
                            placeholder="LL-001"
                          />
                        </div>
                        <div className="space-y-2">
                          <label className="block text-xs font-bold text-neutral-500 uppercase tracking-widest ml-1">Category</label>
                          <select 
                            value={formData.category}
                            onChange={(e) => setFormData({ ...formData, category: e.target.value as any })}
                            className="w-full px-5 py-4 bg-neutral-50 border border-neutral-200 rounded-2xl text-sm font-bold text-neutral-900 focus:ring-4 focus:ring-emerald-500/10 focus:border-emerald-500 transition-all outline-none appearance-none"
                          >
                    ...
                    <section className="space-y-8">
                      ...
                      <div className="space-y-2">
                        <label className="block text-xs font-bold text-neutral-500 uppercase tracking-widest ml-1">Description of Lesson Learned</label>
                        <textarea 
                          value={formData.description}
                          onChange={(e) => setFormData({ ...formData, description: e.target.value })}
                          rows={4}
                          className="w-full px-5 py-4 bg-neutral-50 border border-neutral-200 rounded-2xl text-sm font-semibold text-neutral-900 focus:ring-4 focus:ring-emerald-500/10 focus:border-emerald-500 transition-all outline-none resize-none"
                          placeholder={t('describe_lesson_placeholder')}
                        />
                      </div>

                      <div className="space-y-2">
                        <label className="block text-xs font-bold text-neutral-500 uppercase tracking-widest ml-1">Recommendation for Future Improvements</label>
                        <textarea 
                    ...
                    <section className="space-y-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="space-y-2">
                          <label className="block text-[10px] font-bold text-neutral-500 uppercase tracking-widest ml-1">Impact Direction</label>
                          <div className="flex gap-4">
                             <button
                                ...
                                className={cn(
                                  ...
                                  formData.impact === 'Positive' ? "bg-emerald-50 border-emerald-500 text-emerald-700" : "bg-neutral-50 border-neutral-100 text-neutral-400"
                                )}
                             >
                             ...
                             <button
                                ...
                                className={cn(
                                  "flex-1 p-4 rounded-2xl border-2 flex flex-col items-center gap-2 transition-all group",
                                  formData.impact === 'Negative' ? "bg-rose-50 border-rose-500 text-rose-700" : "bg-neutral-50 border-neutral-100 text-neutral-400"
                                )}
                             >
                        ...
                        <div className="space-y-2">
                          <label className="block text-xs font-bold text-neutral-500 uppercase tracking-widest ml-1">Owner / Primary Contributor</label>
                          <select 
              ...
              <div className="space-y-10">
                <section className="bg-neutral-900 rounded-[3rem] p-10 text-white shadow-2xl relative overflow-hidden group">
                  ...
                  <div className="relative z-10 space-y-8">
                    <div className="flex items-center gap-3 mb-6">
                      ...
                      <div>
                        ...
                        <p className="text-[9px] font-medium text-neutral-500 uppercase tracking-widest">PMIS Knowledge Base</p>
                      </div>
                    </div>

                    <div className="space-y-6">
                      <div className="p-5 bg-white/5 border border-white/10 rounded-[2rem] space-y-1">
                        <div className="text-[9px] font-bold text-neutral-500 uppercase tracking-widest">Current Register Score</div>
                      ...
                      <div className="p-5 bg-white/5 border border-white/10 rounded-[2rem] space-y-1">
                        <div className="text-[9px] font-bold text-neutral-500 uppercase tracking-widest">Distribution</div>
                    ...
                    <div className="pt-6 border-t border-white/10 mt-6">
                      ...
                      <div className="mt-4 p-4 bg-white/5 rounded-2xl border border-white/5 flex items-center gap-3">
                         ...
                         <div className="text-[9px] font-medium text-neutral-400 truncate">
                ...
                <section className="bg-white rounded-[3rem] p-1 shadow-sm border border-neutral-200 overflow-hidden">
                   <div className="p-8 bg-neutral-50/50 border-b border-neutral-100 italic font-bold text-[10px] text-neutral-500 uppercase tracking-[0.2em]">{t('archival_history')}</div>
                   <div className="max-h-[300px] overflow-y-auto p-4 space-y-4 no-scrollbar">
                     {versions.map((v) => (
                       <div key={v.id} className="p-4 bg-white rounded-[1.5rem] border border-neutral-100 flex items-start gap-3 relative overflow-hidden group hover:border-emerald-200 transition-all">
                         ...
                         <div className="w-10 h-10 rounded-xl bg-neutral-50 flex items-center justify-center shrink-0">
                           <History className="w-4 h-4 text-neutral-400 group-hover:text-emerald-600 transition-colors" />
                         </div>
                         <div className="min-w-0">
                           <div className="text-[10px] font-black text-neutral-900 uppercase tracking-tight">{v.editorName}</div>
                           <div className="text-[9px] font-bold text-neutral-400">{new Date(v.timestamp).toLocaleString()}</div>
                     ...
                     {versions.length === 0 && (
                       <div className="py-10 text-center text-neutral-400 text-[10px] font-bold uppercase tracking-widest italic">{t('no_snapshots')}</div>
                     )}
                   </div>
                </section>
          ...
          >
            <div className="mb-6 flex items-center justify-end">
              <button 
                ...
                className="flex items-center gap-2 px-4 py-2 bg-neutral-100 text-neutral-600 rounded-xl font-bold text-[10px] uppercase tracking-widest hover:bg-neutral-200 transition-all"
              >
            ...
            {showHistory && (
              <motion.div 
                ...
                animate={{ opacity: 1, y: 0 }}
                className="bg-neutral-900 rounded-[2rem] p-8 text-white mb-8"
              >
