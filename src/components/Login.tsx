        ...
        <div className="bg-white rounded-[40px] shadow-2xl shadow-blue-900/50 overflow-hidden">
          <div className="p-12 text-center space-y-8">
            ...
            <div className="space-y-2">
              <h2 className="text-2xl font-bold text-slate-800">{t('welcome_back')}</h2>
              <p className="text-slate-500 text-sm">{t('sign_in_desc')}</p>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4 py-4">
              <div className="flex flex-col items-center gap-2">
                ...
                <span className="text-[10px] font-bold text-slate-400 uppercase">{t('projects')}</span>
              </div>
              <div className="flex flex-col items-center gap-2">
                <div className="w-10 h-10 bg-slate-50 rounded-xl flex items-center justify-center text-emerald-600">
                  <HardDrive className="w-5 h-5" />
                </div>
                <span className="text-[10px] font-bold text-slate-400 uppercase">{t('drive')}</span>
              </div>
              <div className="flex flex-col items-center gap-2">
                <div className="w-10 h-10 bg-slate-50 rounded-xl flex items-center justify-center text-amber-600">
                  <ShieldCheck className="w-5 h-5" />
                </div>
                <span className="text-[10px] font-bold text-slate-400 uppercase">{t('secure')}</span>
              </div>
            </div>
          ...
          <div className="bg-slate-50 p-6 border-t border-slate-100 flex items-center justify-center gap-2">
            ...
            <span className="text-[10px] font-bold text-slate-500 uppercase tracking-wider">{t('enterprise_security')}</span>
          </div>
        </div>
      </div>
    </div>
