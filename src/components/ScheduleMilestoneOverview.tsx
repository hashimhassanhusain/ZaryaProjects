      ...
      <div className="space-y-8">
        <header className="space-y-2">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-2xl font-black text-slate-900 tracking-tight">Milestone Alignment Hub</h2>
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-slate-900 rounded-[2rem] p-8 text-white relative overflow-hidden group">
            ...
            <div className="relative z-10 space-y-4">
              ...
              <div>
                <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Total Milestones</p>
                <p className="text-4xl font-black italic tracking-tighter">{charterMilestones.length}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white border border-slate-100 rounded-[2rem] p-8 shadow-sm">
            <div className="space-y-4">
              ...
              <div>
                <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Status Alignment</p>
                <div className="flex items-center gap-2">
                  <span className="text-2xl font-black text-slate-900 tracking-tight">Matched</span>
          ...
          <div className="bg-blue-50 border border-blue-100 rounded-[2rem] p-8">
            <div className="space-y-4">
              ...
              <div>
                <p className="text-[10px] font-black uppercase tracking-widest text-blue-400">Finish Date Constraint</p>
            ...
            <table className="w-full text-left">
              <thead>
                <tr className="bg-slate-50/50">
                  ...
                  <th className="px-8 py-4 text-[10px] font-black uppercase tracking-widest text-slate-400 text-center">Due Date</th>
                  <th className="px-8 py-4 text-[10px] font-black uppercase tracking-widest text-slate-400 text-right">Schedule Link</th>
                </tr>
              </thead>
                ...
                {charterMilestones.map((m: any, idx: number) => (
                  <tr key={m.id || idx} className="hover:bg-slate-50/30 transition-colors group">
                    <td className="px-8 py-6">
                      <span className="text-xs font-black text-slate-400 uppercase">MS-{idx + 1}</span>
                    </td>
                    <td className="px-8 py-6">
        ...
        <section className="p-8 bg-blue-50/30 border border-blue-50 rounded-[2.5rem] flex items-center justify-between">
          ...
          <button className="px-6 py-2.5 bg-slate-900 text-white rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-slate-800 transition-all flex items-center gap-2">
