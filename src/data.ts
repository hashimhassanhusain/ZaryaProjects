...
export const pages: Page[] = [
  ...
  { id: '2.3', title: 'Schedule Domain', parentId: '2.0', type: 'terminal', domain: 'schedule', summary: 'Managing the timely completion of the project.', kpis: [{ label: 'Schedule Health', value: 'Good', status: 'success', icon: 'Clock' }, { label: 'Milestones Defined', value: '100%', status: 'success', icon: 'Target' }] },
  { id: '2.3.3', title: 'Activity List', type: 'terminal', content: 'Comprehensive list of all schedule activities required.', formFields: ['ID', 'Activity', 'Description of Work'], details: { variance: 'None', performance: 'On Time', documentation: 'Activities v2' } },
  { id: '2.3.5', title: 'Milestone List', type: 'terminal', content: 'Significant points or events in the project.', formFields: ['Milestone', 'Milestone Description', 'Type'], details: { variance: 'On Track', performance: 'Stable', documentation: 'Milestones' } },
  { id: '2.3.7', title: 'Project Schedule', type: 'terminal', content: 'Planned dates for performing activities and meeting milestones.', formFields: ['Gantt Chart', 'Milestone Chart', 'WBS', 'Task Name', 'Start', 'Finish'], details: { variance: 'Minimal', performance: 'High', documentation: 'Schedule v4' } },
